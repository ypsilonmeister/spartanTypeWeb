# SpartanType Web - AI Developer Reference (AGENTS.md)

This file contains quick reference commands, coding standards, and architectural blueprints to assist Anthropic's Codex agents in developing, building, and maintaining SpartanType Web.
